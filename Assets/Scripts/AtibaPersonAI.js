...
var VelClamp = Mathf.Clamp(AngVelMod,0.5,8);
...
LeftNum -= 1;
      ...
      Debug.DrawRay (LocalView.position + LocalView.forward * RayLV + LocalView.right * RaySideDist, -LocalView.up * 0.5, Color.black);
if (!Physics.Raycast (LocalView.position + LocalView.forward * RayLV + LocalView.right * RaySideDist, -LocalView.up, hit, 0.5, targetLayers)){
RightDist = 0.1;
if(Pathfind > 20)
Pathfind -= 20;
if(RayDist > 2)
...
UpperBodyAni.CrossFade("Plast2Stand", 0.3f);
}
}
...
if(Anger > 5){
if(!Obscured){
if(!UpperBodyAni.IsPlaying("Plast2AimGun")){
UpperBodyAni.CrossFade("Plast2AimGun", 0.3f);
AimSpeed = 0.1;
}
}else{
if(!UpperBodyAni.IsPlaying("Plast2IdleGun")){
UpperBodyAni.CrossFade("Plast2IdleGun", 0.3f);
AimSpeed = 0.1;
}
}
}
...
if(FreeRoam){
if(TCCol.name.Contains ("C6l"))
Leader = null;
if(Leader)
if(!Leader.name.Contains ("6l"))
Leader = null;
...
if(convNum < 2){
if(speech.Contains ("albel")){ yield WaitForSeconds (1);
audio.PlayOneShot(Beb1); return;}

if(speech.Contains ("abia") && speech.Contains ("infidel")){ convNum = 3; yield WaitForSeconds (2);
ReturnSpeech("Atiba Albel!"); PissedAtTC1 += 8; audio.PlayOneShot(Bib1); return;}
}

if(convNum == 0){
//===============================================================================
if(speech.Contains ("hi") || speech.Contains ("hey")){ convNum = 1; yield WaitForSeconds (2);
ReturnSpeech("Hello friend! \n You've come to trade?"); return;}

if(speech.Contains ("yo")){ convNum = 1; yield WaitForSeconds (2);
ReturnSpeech("Umm. You've come to trade?"); return;}

if(speech.Contains ("hello") || speech.Contains ("greet")){ convNum = 1; yield WaitForSeconds (2);
ReturnSpeech("Greetings, buyer!"); return; }

if(speech.Contains ("abia")){ convNum = 1; yield WaitForSeconds (2);
ReturnSpeech("Excuse me, infidel. \n But that is not to be spoken of!"); return; }
//===============================================================================
}

if(convNum == 1){
//===============================================================================
if(speech.Contains ("ye") || speech.Contains ("sure") || speech.Contains ("course")){ convNum = 2; yield WaitForSeconds (2);
ReturnSpeech("That's great! But I am not a vendor. \n You need to find one, wherever they are."); return;}

if(speech.Contains ("no") || speech.Contains ("nah") || speech.Contains ("nvm")){ convNum = 2; yield WaitForSeconds (2);
ReturnSpeech(". . . Ok then."); return;}

if(speech.Contains ("fuck") || speech.Contains ("shit") || speech.Contains ("ass")){ convNum = 3; yield WaitForSeconds (2);
ReturnSpeech("Excuse me?"); return;}

if(speech.Contains ("hi") || speech.Contains ("hey") || speech.Contains ("yo")){ convNum = 2; yield WaitForSeconds (2);
ReturnSpeech("What do you want?"); return;}

if(speech.Contains ("hello") || speech.Contains ("greet")){ convNum = 2; yield WaitForSeconds (2);
ReturnSpeech("Yes, I am here."); return; }

if(speech.Contains ("abia")){ convNum = 2; yield WaitForSeconds (2);
ReturnSpeech("I warn you, one more time!"); return;}
//===============================================================================
}

if(convNum == 2){
//===============================================================================
if(speech.Contains ("hi") || speech.Contains ("hey") || speech.Contains ("yo")){ convNum = 3; yield WaitForSeconds (2);
ReturnSpeech("Whatever, I'm busy."); return;}

if(speech.Contains ("no") || speech.Contains ("nah") || speech.Contains ("nvm")){ convNum = 2; yield WaitForSeconds (2);
return;}

if(speech.Contains ("fuck") || speech.Contains ("shit") || speech.Contains ("ass")){ convNum = 3; boredom = 4; yield WaitForSeconds (2);
ReturnSpeech("You know what. \n Stay away!"); return;}

if(speech.Contains ("hello") || speech.Contains ("greet")){ convNum = 3; yield WaitForSeconds (2);
ReturnSpeech("What is this?"); return; }

if(speech.Contains ("abia")){ convNum = 3; yield WaitForSeconds (2);
ReturnSpeech("Atiba Albel!"); PissedAtTC1 += 8; audio.PlayOneShot(Bib1); return;}
//===============================================================================
}
...
ReturnSpeech("It's not my job to help \n with your personal issues."); Ogle = 2; return;}
}

//===============================================================================
if(speech.Contains ("fuck you")){ convNum = 99; Ogle = 2; yield WaitForSeconds (2);
PissedAtTC1 += 8; audio.PlayOneShot(Bib1); return;}
...
if(boredom == 1){ReturnSpeech("Please elaborate."); convNum = 1;}
if(boredom == 2){ReturnSpeech("Well, see you later."); convNum = 4; Ogle = 4;}
if(boredom == 3){ReturnSpeech("Goodbye!"); convNum = 4; Ogle = 2;}
if(boredom == 4){ReturnSpeech("Go away, \n you irritating donkey!"); convNum = 4; Ogle = 2;}
if(boredom == 5){ReturnSpeech("Leave me alone! \n I swear to god!"); convNum = 4; Ogle = 2;}
if(boredom == 6){ReturnSpeech("One more time, \n I'll shoot your head off!"); convNum = 4; Ogle = 2;}
if(boredom == 7){ReturnSpeech("Ko ro udma!"); convNum = 5; PissedAtTC1 += 8; Ogle = 2;}
boredom += 1;
}
